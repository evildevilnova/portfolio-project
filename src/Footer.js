                ...
                <footer>
                    <div className="row py-3 justify-content-center ">
                        ...
                        <div className="col-xl-3 col-md-4 col-sm-4 col-auto order-1 align-self-end ">
                            <h6 className="mt-55 mt-2 text-muted bold-text"><b>NISHANT</b></h6><small> <span><i className="fa fa-envelope" aria-hidden="true"></i></span> Nishantlodhi2468@gmail.com</small>
                        </div>
