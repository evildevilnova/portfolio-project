                        ...
                        <form id="contact-form" name="contact-form" onSubmit={sendEmail}>
                            <div className="row">
                                <div className="col-md-6">
                                    ...
                                    <div className="md-form form-group">
                                        <input type="email" className="inputfeild form-control" id="email" name="email" placeholder="Email" />
                                    </div>
                                    <div className="md-form form-group">
                                        <input type="number" className="inputfeild form-control" id="Phone" name="Phone" placeholder="Phone Number" />
                                    </div>
                                    <div className="md-form form-group ">
